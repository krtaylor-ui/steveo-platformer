...
const tests = ['test-pause.js', 'test-v3.js', 'test-scoring.js', 'test-rules.js', 'test-mobs.js', 'test-gamepad-nav.js', 'test-weapons.js', 'test-foliage.js', 'test-detection.js', 'test-webs.js', 'test-pathfinding.js', 'test-wayfinding.js', 'test-platformer-defaults.js', 'test-bot-ai.js', 'test-bot-climb.js', 'test-redstone.js', 'test-keybindings.js', 'test-boomerang.js', 'test-grapple.js', 'test-travel-tube.js', 'test-moving-platform.js', 'test-directional.js', 'test-combos.js', 'test-testworld.js', 'test-gpbindings.js', 'test-weight-sensor.js', 'test-conduct.js', 'test-block-skins.js', 'test-rail-switch.js', 'test-campaign.js', 'test-overhead-core.js', 'test-overhead-map.js'];
let failed = 0;
