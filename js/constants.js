...
const GAME_VERSION = 'v3 build 415: FIX overhead controllers dead in real play: overhead loop never polled gamepad hardware (updateGamepad) — 2D does it in game.js; now polled each frame + slot-sync moved up';
