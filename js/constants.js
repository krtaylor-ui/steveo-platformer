...
const GAME_VERSION = 'v3 build 413: Overhead play polish: controller-setup falls back to keyboard when a saved pad isnt connected (P1 no longer starts on an undetected Gamepad 1); centralize+unit-test the overhead engine-dispatch detection incl the legacy no-viewMode fallback';
