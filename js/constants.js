...
const GAME_VERSION = 'v3 build 464: Epic CK: placeable Speed Runner checkpoints (respawn anchor, keeps the clock) + split timing HUD; ghost hides after a checkpoint. Practice mode deferred';
