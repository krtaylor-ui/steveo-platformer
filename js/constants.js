...
const GAME_VERSION = 'v3 build 451: B6: appropriateness filter (wordlist) on usernames + world names + descriptions, wired into signup + world create/rename; case-folded username uniqueness';
