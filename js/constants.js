...
const GAME_VERSION = 'v3 build 400: Overhead MP 0e: per-player death/respawn - a downed player bursts + respawns at its own spawn while others play on (single-player game-over unchanged)';
