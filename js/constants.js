...
const GAME_VERSION = 'v3 build 378: 368 label fix — the \'Hide from export\' toggle dropped its \'others can\'t download a copy\' protection claim (the brief mandates no protection wording, and the claim was also false while the card-export bug lived); labels/hints/comment now say only that it removes the Export buttons and is NOT protection. Locked the offline-overhead card-gating chain with a test (a saved overhead world\'s settings.hideFromExport hides the card Export)';
