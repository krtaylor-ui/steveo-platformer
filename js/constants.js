...
const GAME_VERSION = 'v3 build 472: Bugfix pass: F1 wind redstone channels (int not string), F2 Import-from-Games stays hidden online, F3 E4 inverted-floor jump, F4 wind-zone-split shadow+config inherit, F6 sandbox fall-catch';
