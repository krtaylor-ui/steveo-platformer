...
const GAME_VERSION = 'v3 build 399: Overhead MP 0c(part2): per-player E-trigger (all players use pipes/portals/levers/goal) + per-pipe pull-all vs single travel toggle';
