...
const GAME_VERSION = 'v3 build 422: Fix 421 tester defects: (1) untagged overhead worlds now show a \'Set play mode…\' placeholder on the card so picking a mode actually applies (were invisible under Platformer); (2) sandbox chests open with E without the avatar being adjacent';
