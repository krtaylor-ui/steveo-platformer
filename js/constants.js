...
const GAME_VERSION = 'v3 build 459: QA seams for the right-click config gestures: SANDBOX.cycleSpikeOrientation (E12) + setBoosterConfig/getBoosterConfig (E6/E5) + getSpikeDir — closes the right-click-blocked items for the rig';
