...
const GAME_VERSION = 'v3 · build 83 (dev: skip + auto-clean the service worker on localhost so it never masks a dropped WSL2 localhost forward or serves a stale build; PWA unchanged in production)';
