...
const GAME_VERSION = 'v3 build 429: In-app modals replace native alert/confirm/prompt (they froze the JS thread + stalled the tester): global non-blocking window.alert override (all 94) + DIALOG.confirm/prompt (14 callers refactored async)';
