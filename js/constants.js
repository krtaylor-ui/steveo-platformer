...
const GAME_VERSION = 'v3 build 499: SR hub: white LCD backlight on the screen; worlds keep neon outline; hover adds a neon glow to that world (not a brighter outline)';
