...
const GAME_VERSION = 'v3 build 490: T3-1: fire Level Challenges on SR finish + reset stats per run; T3-2: Custom Rules teaching-text contrast; Beat Grid save reminder';
