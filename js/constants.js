...
const GAME_VERSION = 'v3 build 424: Custom Sprites Phase 1 foundation: engine-agnostic CHARACTERS registry (16 chars, both engines, feat flags + default palettes) + tests; roster approved from the concept artifact';
