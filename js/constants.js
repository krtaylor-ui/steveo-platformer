...
const GAME_VERSION = 'v3 build 460: E3 polish: Launch Accel/Lift now sit inside the existing Transport group next to Conveyor/Travel Tube (no separate mini-group) + ready-to-run server/sql/speedrunner.sql migrations';
