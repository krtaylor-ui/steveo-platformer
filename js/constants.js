...
const GAME_VERSION = 'v3 build 498: SR hub polish: blue backdrop behind tablet + side space, screen off-black navy tinted to active key, rows glow the neon of the selected key, white hover/controller glow on keys';
