...
const GAME_VERSION = 'v3 build 477: Tranche 1 re-fixes: T1-3 game-slot launcher passes record.world_id (LB re-key), T1-2 Favorite button theme-guard (light-view leak) + darker Download indigo, tag-set route reports dropped non-curated tags';
