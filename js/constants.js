...
const GAME_VERSION = 'v3 build 478: Wind Style picker: per-zone Chevrons / Streamlines / Speed Lines (right-click config), seamless world-space rendering, downwind flow, speed scales with strength';
