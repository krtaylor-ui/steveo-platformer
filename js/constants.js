...
const GAME_VERSION = 'v3 build 423: Speed Run Phase 2 (overhead): finish-enabled goal for speedrunner + run timer HUD (starts on first move) + best-time leaderboard (SpeedRunnerLeaderboard/SPEEDRUN_SYNC, levelId author:worldName) + finish results overlay (time + best)';
