...
const GAME_VERSION = 'v3 · build 245 (Moving Platforms 1 — THE RAIL: a placeable waypoint path (reuses the Travel-Tube click-corners UX + geometry) that platforms will ride. Rail block in the Mechanics palette tab; click corners, click the last point again to finish, or the FIRST point to close a LOOP. Click a placed rail for a modal: cycle Visibility (Visible+Solid / Visible+Non-solid default / Invisible), toggle Loop, Edit Nodes (drag waypoints, double-click an end to extend, Delete a node), or Delete. Solid rails paint standable RAIL grid cells. Pure math in moving-platform.js (advance/weight/centre-of-mass/ballistic/tilt/flood-fill) + 24 headless tests. Serialized across all load/save paths incl. the SpeedRunner gap + localStorage. Prev builds 242-244: redstone converter/lamp/hotbar fixes, TX/RX overlays, direct adjacency power.)';
const CANVAS_W    = 800;
const CANVAS_H    = 500;
const BLOCK_SIZE  = 32;
