...
const GAME_VERSION = 'v3 build 467: Epic C: remove Import-from-Games + redundant Overhead Demo (top-bar tidy). Tabs / overhead-fold / post-create description edit deferred as UI follow-ups';
