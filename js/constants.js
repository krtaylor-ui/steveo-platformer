...
const GAME_VERSION = 'v3 build 461: E7 WIND zones (2D): placed region pushes players by direction+strength; wall-blockable (thick solid casts a downwind shadow) + redstone-gated; right-click config + QA seam';
