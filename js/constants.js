...
const GAME_VERSION = 'v3 · build 87 (Smart Mobs: sprite shows the active-hand weapon (melee vs ranged); melee/ranged mutually exclusive, melee wins ties; cycle updates the shown weapon)';
