...
const GAME_VERSION = 'v3 build 465: Epic D core: per-level achievement evaluator (5 templates) + tests. Creator UI + in-play tracking + persistence route flagged as follow-ups';
