...
const GAME_VERSION = 'v3 build 421: O6 2D sandbox chest: tab bar aligned with the main palette (World/Decor/Plumbing/Gear/Other; removed stale broken Nether tab; draw+click lists now agree so tabs select the right palette); width scales; normalize tab on open; right-click-to-remove already present+labelled';
