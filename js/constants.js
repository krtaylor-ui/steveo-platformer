...
const GAME_VERSION = 'v3 build 471: Epic D3: per-level achievement unlock routes (POST/GET /api/achievements/world) using the applied SQL. Creator UI + in-play tracking + Epic UI modal refactor flagged as follow-ups';
