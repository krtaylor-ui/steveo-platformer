...
const GAME_VERSION = 'v3 build 512: Campaign N-1/N-2: Remove-World button uses cb-btn warn (was cb-plus, label spilled); moderate name on POST /api/campaigns; allow surname collisions (cocktail/Hitchcock/Babcock/Sexton/Damnation)';
