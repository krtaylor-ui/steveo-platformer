...
const GAME_VERSION = 'v3 build 508: Campaign §29: multi-user publishing (owners publish own, multiple allowed) + neon campaign selection screen listing all published campaigns';
