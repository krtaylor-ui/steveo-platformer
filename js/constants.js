...
const GAME_VERSION = 'v3 build 466: Phase 3 roster: user_characters server route + client API + Save-to-Roster in the builder (uses the applied SQL). Picker + MP + side-preview + sprite-sheet deferred';
