...
const GAME_VERSION = 'v3 build 381: Arena: \'Keep Weapons on Death\' — a basic World Settings ▸ Arena toggle (default off). ON = a respawning player keeps the ranged weapons they picked up; OFF = respawn resets to the starting bow. Gated in _armArenaPlayer (arena doesn\'t drop weapons on death and respawnAt doesn\'t clear them, so \'keep\' is just skipping the reset)';
