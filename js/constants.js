...
const GAME_VERSION = 'v3 build 469: Epic MB: Beat Grid core (tap-tempo + time->distance) + tests. Editor overlay + autodetect deferred; MB1 per-instance track already works';
