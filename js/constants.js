...
const GAME_VERSION = 'v3 build 470: Storefront slices: rating sort -> rating_avg, Most-Played/Trending sorts, play_count route, publish sets state + gates on the finish validator (A2). Landing/browse UI deferred';
