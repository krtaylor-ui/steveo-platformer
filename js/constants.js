...
const GAME_VERSION = 'v3 build 510: Campaign safety fixes: moderation catches inflections/leet (C-1) + rename bypass closed (C-2); refill lives after Game Over re-entry (§28); Goal Stars re-derived on publish + Remove-World control';
