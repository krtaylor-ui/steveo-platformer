...
const GAME_VERSION = 'v3 build 379: Arena: \'Start with Grappling Hook\' — a basic World Settings ▸ Arena toggle (default off) that arms every arena player with the grappling hook on setup and every respawn (sets the hasGrapple capability flag in _armArenaPlayer); uses the existing Movement ▸ Grapple settings';
