...
const GAME_VERSION = 'v3 build 384: Grapple now fires from the controller: default the grapple button to the LEFT TRIGGER (button 6), symmetric with ranged-fire on RT. It was abtn(\'grapple\', null) = unbound, so a controller could never fire the grappling hook. A custom binding still overrides; LT is otherwise free in play (undo in Sandbox only)';
