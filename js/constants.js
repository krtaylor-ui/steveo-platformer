...
const GAME_VERSION = 'v3 build 435: FIX character lost on resume (serialize/restore characterId) + local lw- worlds now persist character (LOCAL_WORLDS.setCharacter)';
