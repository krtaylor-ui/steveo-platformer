...
const GAME_VERSION = 'v3 build 412: Overhead play: mode picker on Sandbox card (Platform/Speed Run/Arena, no editor round-trip) + harden play dispatch (mapSnapshot fallback + diagnostic) so overhead worlds never load as 2D';
