...
const GAME_VERSION = 'v3 build 479: Epic D: per-level Achievements — creator UI (Level Challenges) + in-play stat tracking (collect/defeat/jumps/hazard/time) + fire-on-completion + server persist';
