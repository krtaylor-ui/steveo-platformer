...
const GAME_VERSION = 'v3 build 473: Tranche 1 storefront server layer: browse tags/creator/search + play/tags/thumbnail fields, tag routes, creator profile, picks, downloadable+provenance enforcement in download; LB re-key SR levelId -> worlds.id';
