...
const GAME_VERSION = 'v3 build 385: P1 Stick Aim toggle (Controls) — makes player 1 aim by the RIGHT-STICK direction like players 2-4 (angular, no cursor), instead of the free-moving cursor. Places the cursor in the stick direction from the player when on; off by default. Also resolves the \'aim targeter won\'t reach the bottom\' report (angular aim points down directly — no cursor edge to fall short of)';
