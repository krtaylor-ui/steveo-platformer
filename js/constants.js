...
const GAME_VERSION = 'v3 build 430: Fix A1: card Character never persisted (dedicated /character route 404\'d on un-restarted API servers). Persist via the long-standing full-world GET+PUT instead; removed the dedicated route';
