...
const GAME_VERSION = 'v3 build 485: Epic UI: modal dark unification — shared .modal-content family onto the dark shell (modern theme), revertible block; retro untouched';
