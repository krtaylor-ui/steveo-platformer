...
const GAME_VERSION = 'v3 build 482: Epic C: Create World cleanup — Overhead folded into the mode picker + post-create description edit (Info button + /description route)';
