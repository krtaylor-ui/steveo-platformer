...
const GAME_VERSION = 'v3 build 458: QA reachability + GAP-3: window.SANDBOX.selectItem delegate (forwards to the in-editor palette) + scriptable publishWorld (A1) + character builder re-renders the card on Cancel too';
