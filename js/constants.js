...
const GAME_VERSION = 'v3 build 455: B6 fix: moderation now enforced on the REAL create/rename paths — client-side create+rename checks (covers offline/local worlds) + the dedicated cloud /name rename endpoint (was unwired)';
