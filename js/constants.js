...
const GAME_VERSION = 'v3 build 419: O2 pre-game settings window: Speed Run=1P no window; Platform co-op window; Arena window (versus mode/teams/kill-target); D-pad per-player panels (each pad edits only its own; P1 global+Start); appearance swatches + Boy/Girl; keyboard+mouse+gamepad; menu-styled';
