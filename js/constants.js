...
const GAME_VERSION = 'v3 build 441: E6: Speed Boost Zone works outside Speed Runner (movement multiplier) + right-click per-block config (Temporary/Permanent, boost amount, linger duration)';
