...
const GAME_VERSION = 'v3 build 468: Phase 3 roster PICKER — saved account characters appear in the world-card Character dropdown (My Characters) and apply to the world; completes roster create+apply';
