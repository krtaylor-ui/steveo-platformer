...
const GAME_VERSION = 'v3 build 444: E13: the Other palette + chest mirror filter by the world\'s play mode (arena objectives hidden in a Speed Run world, dimensional gear hidden in arena, etc.)';
