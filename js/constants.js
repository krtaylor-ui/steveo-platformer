...
const GAME_VERSION = 'v3 build 428: Custom Sprites Phase 1 (4): tests — worldData.characterId flows to overhead runtime; unknown id resolves to classic feat; character NEVER changes hitbox (r/hp) — fairness guarantee';
