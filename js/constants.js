...
const GAME_VERSION = 'v3 build 431: Custom Sprites 430-test fixes: offline-overhead (oh- id) cards now save Character to localStorage (were 404); native window.confirm/prompt safety-overridden (no freeze); overhead tail attaches to body';
