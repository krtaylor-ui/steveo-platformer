...
const GAME_VERSION = 'v3 build 456: QA fixes: E8 test-world levelId collision guard + SANDBOX.selectItem(name) automation hook (place any palette block without the canvas palette)';
