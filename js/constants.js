...
const GAME_VERSION = 'v3 build 411: Overhead PLAY path Phase 1: editor mode picker (PLT/RUN/ARN) + viewMode engine dispatch + OVERHEAD_PLAY (pre-launch controller setup + in-game pause controller panel + non-test launch)';
