...
const GAME_VERSION = 'v3 build 476: Tranche 1 fixes: T1-2 card CTA contrast (invisible buttons), T1-3 SR launcher threads worldId + data fallback for LB re-key, publishWorld seam sends downloadable. + server/sql/tranche1_fixes.sql for T1-1 rating_avg-generated + downloadable backfill + tag seeds';
