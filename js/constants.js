...
const GAME_VERSION = 'v3 build 414: Overhead Arena launch: ARENA_SELECT routes overhead worlds to OVERHEAD_PLAY (was loading them as a 2D scrolling map); Arena defaults the world to Deathmatch versus';
