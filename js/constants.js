...
const GAME_VERSION = 'v3 build 427: Custom Sprites Phase 1 (3/3): single-pick character-select — overhead pre-game window Character field + side/overhead Sandbox card Character dropdown (persists world_data.characterId via new /character endpoint); per-player Body(boy/girl) relabeled; MP colour unchanged';
