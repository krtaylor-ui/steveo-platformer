...
const GAME_VERSION = 'v3 build 449: E5: Speed Runner Player Speed Zones — a run of Speed Boost blocks is a placed speed region; per-block config sets its strength, Permanent = a sustained zone, Temporary = a burst';
