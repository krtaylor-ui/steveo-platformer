...
const GAME_VERSION = 'v3 build 450: E10: Speed Runner rule-set presets (Classic/Auto-Scroller/Plumber/Shape Run/Zen Flow) — one click sets a batch of Pace settings, all still editable';
