...
const GAME_VERSION = 'v3 build 454: FIX Phase 2 Save no-op (window.SANDBOX undefined) + list-vanish + custom palette wins in play + Surprise-Me body + bigger preview';
