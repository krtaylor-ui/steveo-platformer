...
const GAME_VERSION = 'v3 build 433: FIX overhead P1 controller dead: _rawFor read phantom gp.axes0/axes1/axes2/axes3/rt + hardcoded gamepads[0]; now reads P1\'s ASSIGNED pad via pGp(0) with real fields (moveX/moveY/aimX/aimY/triggerR)';
