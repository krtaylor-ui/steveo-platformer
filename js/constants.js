...
const GAME_VERSION = 'v3 build 457: Phase 2 GAP fixes: unify oh-/lw-/server character writers into one _persistWorldData (fixes offline-overhead Save no-op) + GAP-3 char dropdown no longer blanks on Cancel';
