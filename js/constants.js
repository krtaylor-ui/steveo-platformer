...
const GAME_VERSION = 'v3 build 503: Level Hub: Normal/Platformer Play/Continue/Restart via per-(user,world) progress store (world_progress.sql); save-on-exit + clear-on-win';
