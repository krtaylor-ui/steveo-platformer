...
const GAME_VERSION = 'v3 build 434: App version badge shows just the number (long note pushed Logout off-screen); overhead pre-game window: B cancels/backs out';
