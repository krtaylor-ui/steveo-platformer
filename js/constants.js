...
const GAME_VERSION = 'v3 build 439: Phase 2 builder UI: parts-mixer modal (part dropdowns + colours + name + live overhead preview + Surprise Me) from Sandbox card Custom option';
