...
const GAME_VERSION = 'v3 build 438: Phase 2: persist + wire customCharacter into both engines (serialize/deserialize + game.js + overhead-game setCustom) + local/offline save helpers';
