...
const GAME_VERSION = 'v3 build 511: Campaign C-1b/C-3 + polish: stem-match moderation (no over-block: document/spicy/skyscraper), 9->g + spaced evasion; resyncStars uses sandboxWorldUid + resync on edit; campaign pause/publish copy; hide canvas on exit; suppress engine LEVEL COMPLETE in campaign';
