...
const GAME_VERSION = 'v3 build 507: Arena hub: game-type buttons now FILTER the map list to maps that support that type (server returns supportedModes; client filters + re-renders on click)';
