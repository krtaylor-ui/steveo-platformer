...
const GAME_VERSION = 'v3 build 496: SR hub layout fix: init sets display:flex (inline block was overriding), widen container to 1240 so rail sits beside the list full-width';
