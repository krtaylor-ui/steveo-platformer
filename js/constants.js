...
const GAME_VERSION = 'v3 build 416: Per-player appearance model (PLAYER_LOOKS: Boy/Girl + skin/hair/shirt/pants, distinct P1-P4 defaults, team=shirt colour) wired into the overhead sprite renderer + Boy/Girl hair';
