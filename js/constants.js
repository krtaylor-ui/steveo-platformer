...
const GAME_VERSION = 'v3 build 446: E1: Speed Runner Pace split — Base + Max as precise slider+number-box inputs, Max=Base (no speed-up) toggle, Instant acceleration option';
