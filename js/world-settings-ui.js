...
const WORLD_SETTINGS = {
  ...
  get SETTINGS() {
    ...
    return [
      ...
      { key: 'companionTeleport', tab: 'world', group: 'Players', modes: M.adventure, type: 'toggle', get: (a) => a.companionTeleport !== false, set: (a, v) => { a.companionTeleport = v; }, label: 'Companion Summon (press C)', hint: 'when the companion gets too far it shows a yellow “!” — press C to warp it to you (it never auto-teleports). Turn OFF to stress-test navigation with the stuck behaviour below.' },
