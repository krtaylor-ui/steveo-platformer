...
const WORLD_SETTINGS = {
  ...
  get SETTINGS() {
    ...
    return [
      ...
      { key: 'companionTeleport', tab: 'world', group: 'Players', modes: M.adventure, type: 'toggle', get: (a) => a.companionTeleport !== false, set: (a, v) => { a.companionTeleport = v; }, label: 'Companion Teleport', hint: 'if the companion bot can’t reach you, it warps to you (turn off to stress-test its navigation)' },
