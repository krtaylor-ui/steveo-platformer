...
const WORLD_SETTINGS = {
  ...
  get SETTINGS() {
    ...
    return [
      ...
      { key: 'tubeRoundedCorners', tab: 'movement', group: 'Moves', modes: M.physics, type: 'toggle', dflt: false, label: 'Travel Tube: Rounded Bends', hint: 'draw Travel Tubes as a smooth pipe with ROUNDED bends + full-width rounded mouths (the body runs a touch narrower). Off = classic square corners' },
