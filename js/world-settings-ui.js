...
const WORLD_SETTINGS = {
  ...
  get SETTINGS() {
    ...
    return [
      ...
      { key: 'barTraverseStyle', tab: 'movement', group: 'Moves', modes: M.physics, type: 'cycle', opts: ['smooth', 'brachiation', 'bigswing', 'lunge'], dflt: 'brachiation', label: 'Bar: Traverse Style', fmt: (v) => ({ smooth: 'Smooth', brachiation: 'Brachiation', bigswing: 'Big Swing', lunge: 'Lunge' }[v] || v), sub: true, advanced: true, hint: 'the hand-over-hand animation: Smooth (tight shuffle) · Brachiation (natural monkey-bar rock — default) · Big Swing (wide, heavy weight-shift) · Lunge (snappy snatch with a leg kick)' },
