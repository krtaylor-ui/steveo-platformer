...
const WORLD_SETTINGS = {
  ...
  get SETTINGS() {
    ...
    return [
      ...
      { key: 'companionTeleport', tab: 'world', group: 'Players', modes: M.adventure, type: 'toggle', get: (a) => a.companionTeleport !== false, set: (a, v) => { a.companionTeleport = v; }, label: 'Companion Teleport', hint: 'warp the companion to you once it gets too far (fast pace — never wait for it). Turn off to stress-test its navigation.' },
      { key: 'companionTeleportRange', tab: 'world', group: 'Players', modes: M.adventure, type: 'cycle', opts: [12, 16, 20, 24, 30, 40], dflt: 20, label: 'Teleport Range', fmt: (v) => v + ' blocks', sub: true, hint: 'direct distance (counts vertical) before the companion warps to you' },
      ...
      { key: 'p2Char', tab: 'world', group: 'Players', modes: M.adventure, type: 'cycle', opts: ['male', 'female'], dflt: 'male', label: 'P2 / Companion Character', fmt: (v) => v === 'female' ? 'Alex ♀' : 'Steve ♂', hint: 'player 2 / companion sprite' },
