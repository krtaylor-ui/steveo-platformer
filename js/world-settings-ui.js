...
const WORLD_SETTINGS = {
  ...
  get SETTINGS() {
    ...
    return [
      ...
      { key: 'hideFromExport', tab: 'world', group: 'Designer Locks', modes: ['sandbox'], type: 'toggle', dflt: false, label: 'Hide from export', advanced: true, hint: '§40.1 — ON hides the Export buttons for this world so other people can’t download a copy. You can always turn it off here in Sandbox; the server still lets you (the owner) export your own world. This is “don’t let other people take it”, not encryption — anyone can still read the JSON in their browser.' },
