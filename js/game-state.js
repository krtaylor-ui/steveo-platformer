...
const GAME_STATE = {
  ...
  serialize(game) {
    ...
    return {
      ...
      rails:          game._rails ? game._rails.map(r => ({ id: r.id, cells: r.cells, vis: r.vis || 'visible', loop: !!r.loop, angled: !!r.angled, pauseNodes: r.pauseNodes || [], collideMode: r.collideMode || 'passthrough', speedSegments: r.speedSegments || [], launchAt: r.launchAt ?? null })) : [],
