  ...
  _pathToward(gc, gr) {
    ...
    if (stale) {
      ...
      const res = (typeof findMobPath === 'function')
        ? findMobPath(this._nav(), [cc, cr], [gc, gr], { maxRadius: radius, maxExpansions: BOT_PATH_MAX_EXPANSIONS, maxUp: env.maxUp, maxDx: env.maxDx, wallClimb: env.wallClimb, vBias: BOT_PATH_VBIAS, partial: true, maxDrop: 12 })
        : null;
